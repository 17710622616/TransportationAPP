...
/**
 * Created by John_Li on 2019/5/28.
 */
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (!handleException(ex) && mDefaultHandler != null) {//如果自己没处理交给系统处理
            ...
            try {//延迟3秒杀进程
                ...
                Log.d("TAException",e.getMessage());
            }
            System.exit(0);
        }
    }
    ...
    public void collectDeviceInfo(Context ctx) {
        ...
        try {
            ...
            Log.d("TAException","an error occured when collect package info", e);
        }
        //获取所有系统信息
        ...
        for (Field field : fields) {
            try {
                ...
                Log.d("TAException","an error occured when collect crash info", e);
            }
        }
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            Log.d("TAException","an error occured while writing file...");
        }
        return null;
    }
}
