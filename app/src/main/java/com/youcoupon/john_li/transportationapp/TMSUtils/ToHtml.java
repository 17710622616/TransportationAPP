...
public class ToHtml {
    ...
    private static final String mHtmlHead7 = "</font></td> </tr>  <tr><td algin=\"left\"><font size=\"5\">日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期：" + TMSCommonUtils.getTimeToday() +
    ...
    public static void convert(String invoiceNo, String reference, String customerID, String customerName, String path, List<DeliverInvoiceModel> list, String barCodeImagePath, Context context) {//, String name[], int sendOut[], int recycle[]
        try {
            String result = "";
            if (invoiceNo != null) {
                if (!invoiceNo.equals("")) {
